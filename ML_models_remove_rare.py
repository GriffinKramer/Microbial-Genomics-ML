...
writer = pd.ExcelWriter('results/ML_remove_rare_classification_reports.xlsx', engine='openpyxl')
...
results_df.to_csv('results/ML_remove_rare_summary.csv', index=False)
