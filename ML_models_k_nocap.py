...
train_kmers_country = train_kmers_country.values
test_kmers_country = test_kmers_country.values
train_kmers_region = train_kmers_region.values
test_kmers_region = test_kmers_region.values
...
writer = pd.ExcelWriter('results/ML_k_nocap_classification_reports.xlsx', engine='openpyxl')
...
results_df.to_csv('results/ML_k_nocap_summary.csv', index=False)
