...
writer = pd.ExcelWriter('results/ML_no_removal_classification_reports.xlsx', engine='openpyxl')
...
results_df.to_csv('results/ML_no_removal_summary.csv', index=False)
