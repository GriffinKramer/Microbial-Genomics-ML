...
# Feature selection
selector_country = SelectKBest(chi2, k=5000)
...
selector_region = SelectKBest(chi2, k=5000)
...
writer = pd.ExcelWriter('results/ML_k_5000_classification_reports.xlsx', engine='openpyxl')
...
results_df.to_csv('results/ML_k_5000_summary.csv', index=False)
