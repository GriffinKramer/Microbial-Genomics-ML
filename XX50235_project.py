...
## GBDT
### country
pred = gbdt_country_resampled.predict(test_kmers_country)
print("GBDT country resampled - balanced accuracy:", balanced_accuracy_score(test_country, pred))
print(classification_report(test_country, pred))
pred = gbdt_country.predict(test_kmers_country)
print("GBDT country no rebalancing - balanced accuracy:", balanced_accuracy_score(test_country, pred))
print(classification_report(test_country, pred))
### region
pred = gbdt_region_resampled.predict(test_kmers_region)
print("GBDT region resampled - balanced accuracy:", balanced_accuracy_score(test_region, pred))
print(classification_report(test_region, pred))
pred = gbdt_region.predict(test_kmers_region)
print("GBDT region no rebalancing - balanced accuracy:", balanced_accuracy_score(test_region, pred))
print(classification_report(test_region, pred))

## random forest
### country 
pred_country_resampled = rf_country_resampled.predict(test_kmers_country)
print("RF country resampled - balanced accuracy:", balanced_accuracy_score(test_country, pred_country_resampled))
print(classification_report(test_country, pred_country_resampled))
pred_country = rf_country.predict(test_kmers_country)
print("RF country no rebalancing - balanced accuracy:", balanced_accuracy_score(test_country, pred_country))
print(classification_report(test_country, pred_country))
### region
pred_region_resampled = rf_region_resampled.predict(test_kmers_region)
print("RF region resampled - balanced accuracy:", balanced_accuracy_score(test_region, pred_region_resampled))
print(classification_report(test_region, pred_region_resampled))
pred_region = rf_region.predict(test_kmers_region)
print("RF region no rebalancing - balanced accuracy:", balanced_accuracy_score(test_region, pred_region))
print(classification_report(test_region, pred_region))

## SVM
### country
pred = svm_country_resampled.predict(test_kmers_country)
print("LinearSVC country resampled - balanced accuracy:", balanced_accuracy_score(test_country, pred))
print(classification_report(test_country, pred))
pred = svm_country.predict(test_kmers_country)
print("LinearSVC country no rebalancing - balanced accuracy:", balanced_accuracy_score(test_country, pred))
print(classification_report(test_country, pred))
### region
pred = svm_region_resampled.predict(test_kmers_region)
print("LinearSVC region resampled - balanced accuracy:", balanced_accuracy_score(test_region, pred))
print(classification_report(test_region, pred))
pred = svm_region.predict(test_kmers_region)
print("LinearSVC region no rebalancing - balanced accuracy:", balanced_accuracy_score(test_region, pred))
print(classification_report(test_region, pred))
################################################################

# Model Results
## Save Classification Results
writer = pd.ExcelWriter('classification_reports.xlsx', engine='openpyxl')
